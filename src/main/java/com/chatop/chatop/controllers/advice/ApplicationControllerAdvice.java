package com.chatop.chatop.controllers.advice;
...
public class ApplicationControllerAdvice {
    ...
    public @ResponseBody ErrorEntity handleDataIntegrityViolationException(DataIntegrityViolationException exception){
        logger.error("Erreur d'intégrité des données: {}", exception.getMessage());
        return new ErrorEntity(HttpStatus.BAD_REQUEST.value(), "Erreur d'intégrité des données: " + exception.getMessage());
    }
